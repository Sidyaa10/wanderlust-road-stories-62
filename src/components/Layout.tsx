    ...
    <div className="min-h-screen flex flex-col">
        ...
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <Link 
                to="/explore" 
                className={cn("nav-link", isActive("/explore") && "active")}
              >
                Explore
              </Link>
              <Link 
                to="/create" 
                className={cn("nav-link", isActive("/create") && "active")}
              >
                Create
              </Link>
              <Link 
      ...
      <footer className="bg-forest-800 text-white py-12">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">Wanderlust Road Stories</h3>
              <p className="text-sm text-gray-300">
                Discover and share amazing road trip experiences from around the world.
                Plan your next adventure with our community of road travelers.
              </p>
            </div>
            <div>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-border z-10">
        <div className="flex justify-around">
          <Link to="/" className={cn("flex flex-col items-center py-2 px-3", isActive("/") && "text-forest-700")}>
            <Compass className="h-6 w-6" />
            <span className="text-xs mt-1">Home</span>
          </Link>
          <Link to="/explore" className={cn("flex flex-col items-center py-2 px-3", isActive("/explore") && "text-forest-700")}>
            <Search className="h-6 w-6" />
            <span className="text-xs mt-1">Explore</span>
          </Link>
          <Link to="/create" className={cn("flex flex-col items-center py-2 px-3", isActive("/create") && "text-forest-700")}>
